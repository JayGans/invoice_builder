...
import 'package:invoice_builder/utils/constants.dart';
...
class Validator {
  ...
  static String validateEmptyName(String value) {
    ...
    if (value.isEmpty) {
      return Constants.ENTER_CMPNAME;
    }

    return null;
  }
  static String validateEmptyPhone(String value) {


    if (value.isEmpty) {
      return Constants.ENTER_PHONE;
    }
